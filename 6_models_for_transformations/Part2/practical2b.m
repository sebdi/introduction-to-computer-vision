...
%of the practical is to take a real image containing
...
%points
xImCart2 = projectiveCamera(K,TEst,XWireFrameCart(:,1:4));
plot([xImCart2(1,:) xImCart2(1,1)],[xImCart2(2,:) xImCart2(2,1)]);
xImCart3 = projectiveCamera(K,TEst,XWireFrameCart(:,5:end));
plot([xImCart3(1,:) xImCart3(1,1)],[xImCart3(2,:) xImCart3(2,1)]);
plot([xImCart2(1,1) xImCart3(1,1)],[xImCart2(2,1) xImCart3(2,1)]);
plot([xImCart2(1,2) xImCart3(1,2)],[xImCart2(2,2) xImCart3(2,2)],'--');
plot([xImCart2(1,3) xImCart3(1,3)],[xImCart2(2,3) xImCart3(2,3)]);
plot([xImCart2(1,4) xImCart3(1,4)],[xImCart2(2,4) xImCart3(2,4)]);
